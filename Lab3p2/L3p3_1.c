...
#define CODEC_FS        FS_48000_HZ         // Frecuencia de muestreo, revisar L138_LCDK_aic3106_init.h
...
#define PB_TRIM_COUNTER_DELAY_PERIOD    (48000)     // (16000) para 1s @ 16ksps
#define PB_TRIM_COUNTER_AUTOINC_PERIOD  (480)       // (320)    para 20ms @16ksps
...
//        idx_r = ((idx_r+1)%BUFFERSIZE);
       ...
       xl[0]=float_in_l;
        ...
        // Salida L
        float_out_l = (b_k[0]*xl[0] + b_k[1]*xl[1] + b_k[2]*xl[2]);
        // Salida R
