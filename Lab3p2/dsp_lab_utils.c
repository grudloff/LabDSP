...
/***************************************************************************//**
*   \brief  Calcula los coeficientes discretos de un filtro pasabajos basado
*           en un modelo continuo y discretizado por la aproximación bilineal.
*
*   \param Void.
*
*   \return
*******************************************************************************/
void DLU_biquad_lpf_coff(void){
}
