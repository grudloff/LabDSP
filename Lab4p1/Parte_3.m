...
%No se puede sacar mucha información a simple vista de la señal con ruido
...
%Es 26.4 dB más grande, que es 20.87 en veces
...
%Se obtiene un piso de ruido mucho más bajo del orden de 38db ,85.47 veces
%porque???????? (esto falta)