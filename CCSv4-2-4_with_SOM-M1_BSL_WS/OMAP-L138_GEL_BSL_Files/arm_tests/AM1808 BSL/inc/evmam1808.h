//-----------------------------------------------------------------------------
// \file    evmam1808.h
// \brief   AM-1808 internal registers & bit definitions.
//
//-----------------------------------------------------------------------------
...
#include "evmam1808_psc.h"
#include "evmam1808_pll.h"
...
void EVMAM1808_lpscTransition(psc_regs_t *psc_reg, uint32_t in_domain, uint8_t in_module, uint8_t in_next_state);
