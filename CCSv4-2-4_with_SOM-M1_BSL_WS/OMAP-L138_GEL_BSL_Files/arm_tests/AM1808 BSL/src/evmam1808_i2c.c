//-----------------------------------------------------------------------------
// \file    evmam1808_i2c.c
// \brief   implementation of a i2c driver for AM-1808.
//
//-----------------------------------------------------------------------------
...
uint32_t I2C_init(i2c_regs_t *i2c, i2c_clk_e in_clock_rate)
{
   ...
   {
      case I2C0_REG_BASE:
         EVMAM1808_pinmuxConfig(PINMUX_I2C0_REG, PINMUX_I2C0_MASK, PINMUX_I2C0_VAL);
         break;

      case I2C1_REG_BASE:
         EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_I2C1, PSC_ENABLE);
         EVMAM1808_pinmuxConfig(PINMUX_I2C1_REG, PINMUX_I2C1_MASK, PINMUX_I2C1_VAL);
         break;
