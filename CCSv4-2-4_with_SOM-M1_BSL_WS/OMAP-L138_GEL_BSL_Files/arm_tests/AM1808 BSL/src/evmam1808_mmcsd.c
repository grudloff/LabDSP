//-----------------------------------------------------------------------------
// \file    evmam1808_mmcsd.c
// \brief   implementation of the mmc/sd driver for the AM-1808 EVM.
//
//-----------------------------------------------------------------------------
...
uint32_t MMCSD_init(mmcsd_regs_t *mmcsd)
{
   ...
   switch ((uint32_t)mmcsd)
   {
      case MMCSD0_REG_BASE:
         ...
         EVMAM1808_pinmuxConfig(PINMUX_MMCSD0_REG_0, PINMUX_MMCSD0_MASK_0, PINMUX_MMCSD0_VAL_0);
         EVMAM1808_pinmuxConfig(PINMUX_MMCSD0_REG_1, PINMUX_MMCSD0_MASK_1, PINMUX_MMCSD0_VAL_1);
         break;
      
      case MMCSD1_REG_BASE:
         EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_MMCSD1, PSC_ENABLE);
         EVMAM1808_pinmuxConfig(PINMUX_MMCSD1_REG_0, PINMUX_MMCSD1_MASK_0, PINMUX_MMCSD1_VAL_0);
         EVMAM1808_pinmuxConfig(PINMUX_MMCSD1_REG_1, PINMUX_MMCSD1_MASK_1, PINMUX_MMCSD1_VAL_1);
         break;
