//-----------------------------------------------------------------------------
// \file    evmam1808.c
// \brief   implementation of initialization functions for AM-1808.
//
//-----------------------------------------------------------------------------

#include "types.h"
#include "evmam1808.h"
#include "evmam1808_ddr.h"
...
//    ERR_INIT_FAIL - something happened during initialization.
//-----------------------------------------------------------------------------
uint32_t EVMAM1808_initRAM(void)
{
   uint32_t rtn = 0;
...
// \return  none.
//-----------------------------------------------------------------------------
void EVMAM1808_pinmuxConfig(uint32_t in_reg, uint32_t in_mask, uint32_t in_val)
{
...
// \return  none.
//-----------------------------------------------------------------------------
void EVMAM1808_lpscTransition(psc_regs_t *psc, uint32_t in_domain, uint8_t in_module, uint8_t in_next_state)
{
...
uint32_t init_psc(void)
{
   ...
   EVMAM1808_lpscTransition(PSC0, DOMAIN0, LPSC_SPI0, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC0, DOMAIN0, LPSC_MMCSD0, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC0, DOMAIN0, LPSC_AINTC, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC0, DOMAIN0, LPSC_UART0, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC0, DOMAIN0, LPSC_SCR0, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC0, DOMAIN0, LPSC_SCR1, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC0, DOMAIN0, LPSC_SCR2, PSC_ENABLE);
   ...
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_USB0, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_USB1, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_GPIO, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_HPI, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_EMAC, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_MCASP0, PSC_ENABLE);
//    EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_SATA, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_VPIF, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_SPI1, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_I2C1, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_UART1, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_UART2, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_MCBSP0, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_MCBSP1, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_LCDC, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_PWM, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_MMCSD1, PSC_ENABLE);
   EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_RPI, PSC_ENABLE);
//    EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_ECAP, PSC_ENABLE);
//    EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_SCR8, PSC_ENABLE);
//    EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_SCR7, PSC_ENABLE);
//    EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_SCR12, PSC_ENABLE);
//    EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_SHRAM, PSC_ENABLE);
...
// configure arm to 300 MHz and emif to 133MHz.
//-----------------------------------------------------------------------------
