//-----------------------------------------------------------------------------
// \file    evmam1808_spi.c
// \brief   implementation of a spi driver for AM-1808.
//
//-----------------------------------------------------------------------------
...
uint32_t SPI_init(spi_regs_t *spi, spi_config_t *in_config)
{
   ...
   switch ((uint32_t)spi)
   {
      case SPI0_REG_BASE:
         ...
         EVMAM1808_pinmuxConfig(PINMUX_SPI0_REG_0, PINMUX_SPI0_MASK_0, PINMUX_SPI0_VAL_0);
         EVMAM1808_pinmuxConfig(PINMUX_SPI0_REG_1, PINMUX_SPI0_MASK_1, PINMUX_SPI0_VAL_1);
         break;
         
      case SPI1_REG_BASE:
         EVMAM1808_lpscTransition(PSC1, DOMAIN0, LPSC_SPI1, PSC_ENABLE);
         EVMAM1808_pinmuxConfig(PINMUX_SPI1_REG, PINMUX_SPI1_MASK, PINMUX_SPI1_VAL);
         break;
