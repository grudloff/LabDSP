//-----------------------------------------------------------------------------
// \file    evmam1808_nand.c
// \brief   implementation of the nand driver for the AM-1808 EVM.
//
//-----------------------------------------------------------------------------
#include "stdio.h"
#include "types.h"
...
uint32_t NAND_init(void)
{
   ...
   EVMAM1808_pinmuxConfig(PINMUX_EMIFA_NAND_REG_0, PINMUX_EMIFA_NAND_MASK_0, PINMUX_EMIFA_NAND_VAL_0);
   EVMAM1808_pinmuxConfig(PINMUX_EMIFA_NAND_REG_1, PINMUX_EMIFA_NAND_MASK_1, PINMUX_EMIFA_NAND_VAL_1);
   EVMAM1808_pinmuxConfig(PINMUX_EMIFA_NAND_REG_2, PINMUX_EMIFA_NAND_MASK_2, PINMUX_EMIFA_NAND_VAL_2);
