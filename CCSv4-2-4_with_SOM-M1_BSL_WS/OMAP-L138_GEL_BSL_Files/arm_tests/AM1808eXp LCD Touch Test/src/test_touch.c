//------------------------------------------------------------------------------
// \file    test_touch.c
// \brief   implementation of AM-1808 touch test.
//
//-----------------------------------------------------------------------------
#include "stdio.h"
#include "types.h"
...
uint32_t TEST_touch(void)
{
   ...
   printf("Logic Display Kit and the PMIC to output touch interrupts. \r\n");
